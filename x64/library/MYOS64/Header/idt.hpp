...
public:
	...
	InterruptHandler(void* Handler = default_handler, IDT_Type Table_type = IDT_Type::INTERRUPT, Permission Privilege_level = Permission::KERNEL, uint16 Code_segment = 0x08) {
		handler = Handler;
